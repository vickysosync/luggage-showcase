...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Chandok Bag House — Premium Bags & Luggage" },
      {
        name: "description",
        content:
          "Chandok Bag House, Pimpri-Chinchwad: school bags, laptop backpacks, luggage and custom corporate bag manufacturing.",
      },
      { name: "author", content: "Chandok Bag House" },
